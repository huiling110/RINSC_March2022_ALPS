...
colors = [ROOT.kBlack, ROOT.kCyan+1, ROOT.kBlue+1, ROOT.kViolet+1, ROOT.kGreen-1, ROOT.kRed+1]

for drawindex, postfix in enumerate(["_1MOhm", "_10minAnnealing", "_20minAnnealing", "_30minAnnealing", "_40minAnnealing", "_50minAnnealing"]):
    measID = _measID+postfix
    label = "no additional annealing" if postfix=="_1MOhm" else postfix.replace("_", "").replace("minAnnealing", " min at 60^{#circ}C")
